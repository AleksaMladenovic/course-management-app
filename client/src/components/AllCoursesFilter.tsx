...
const AllCoursesFilter = ({ onApplyFilter }: { onApplyFilter: (props: AllCoursesFilterProps) => void }) => {
    ...
    return (
        <div className="w-full bg-[#141b2d]/50 backdrop-blur-xl border border-white/5 p-8 rounded-[2.5rem] shadow-2xl mb-12 animate-in fade-in slide-in-from-top-4 duration-700">
            ...
            {/* AKCIJE */}
            <div className="flex flex-col sm:flex-row items-center justify-end gap-4 mt-10 pt-8 border-t border-white/5">
                <button 
                    onClick={handleClear}
